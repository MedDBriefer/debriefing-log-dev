...
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/App.js";
...
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/components/Analyze.js";
...
function Analyze({
  ...
  const [loaded, setLoaded] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false); // eslint-disable-next-line
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    !!scenario && processEvents(); //console.log("check on existing analysis")
...
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/components/AnalyzeDebriefing.js";
...
/* harmony import */ var react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9663);
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/components/DebLog.js";
...
function DebLog() {
  ...
  const [log, setLog] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  ...
  const [loaded, setLoaded] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false); // can I do a firebase search with a "-*" wildcard?

  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    (0,_meddbriefer_scenario_data_index__WEBPACK_IMPORTED_MODULE_2__.getDebriefCommentLog)(db, logID).then(logData => {
      //console.log("retrieve Debriefing comment file in DebLog:", logData)
      setLog(logData);
    }).catch(() => {
      setNeedAnalysisLog(true); //console.log ("no existing comment log found so will try to display analysis in comment mode")
    });
  }, [db, logID]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    !!needAnalysisLog && (0,_meddbriefer_scenario_data_index__WEBPACK_IMPORTED_MODULE_2__.getDebriefLog)(db, logID).then(logData => {
      //console.log("retrieve Debriefing analysis file in DebLog:", logData)
      setLog(logData);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    !!log && (0,_meddbriefer_scenario_data_index__WEBPACK_IMPORTED_MODULE_2__.getPublishedScenarioObjectByID)(db, log.scenarioID).then(scenData => {
      setScenario(scenData); //console.log("scenario in DebLog", scenData)
    });
  }, [log]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
...
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/components/DisplayBaseDebriefing.js";
    ...
    if (entry.id === "assessmentHeader") {
      ...
      return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxDEV)(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxDEV)("td", {
          ...
          children: (0,_meddbriefer_analysis_debriefingUtils__WEBPACK_IMPORTED_MODULE_4__.getPhaseFeedback)(entry)
        }, void 0, false, {
          fileName: _jsxFileName,
          lineNumber: 74,
          columnNumber: 21
...
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/components/MDBNavBar.js";
...
/* harmony import */ var react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9663);
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/components/UnauthedLayout.js";
...
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/main.js";
...
/* harmony import */ var _meddbriefer_scenario_data_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8913);
/* harmony import */ var react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9663);
var _jsxFileName = "/home/pitt/projects/monorepo/apps/debriefer/src/routes/LogList.js";
...
/* harmony import */ var _meddbriefer_feedback_data_analysisData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7686);
/* harmony import */ var _debriefingUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5064);
...
function initGlobals(scen) {
  problemStates = (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.getStatesForStatus)("Problem");
  cautionStates = (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.getStatesForStatus)("Caution");
  scenario = scen;
  (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.initializeConstraints)(scen.name);
  getAnswerIDs(scen);
  getPromptIDs(scen);
        ...
        problems.forEach((prob, j) => {
          ...
          prob.allActions?.forEach((action, k) => {
            if (action.id === eventObj.id) {
              ...
              statusChecking = _meddbriefer_feedback_data_analysisData__WEBPACK_IMPORTED_MODULE_1__.intvChecks[eventObj.label];

              if (!statusChecking) {
                statusChecking = _meddbriefer_feedback_data_analysisData__WEBPACK_IMPORTED_MODULE_1__.intvChecks[eventObj.id];
              }
  ...
  for (let phaseIndex = 0; phaseIndex < phaseNames.length; phaseIndex++) {
    ...
    if (phaseObjects.length > 0 && !hasSubPhases(phaseName)) {
      ...
      phaseObjectNames.forEach(entry => {
        (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.pushNew)(entry, uniqueListOfNames);
      });
...
const processFirstArg = (firstArgItem, phases, phaseNames, entryNames, entries) => {
  let constraint = (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.getConstraint)(firstArgItem); //will find only one constraint per 1st arg
...
const checkForMissingAssessments = (problems, events, confirmedEvents, phaseNames, phases) => {
  ...
  for (let exceptionDef of _meddbriefer_feedback_data_analysisData__WEBPACK_IMPORTED_MODULE_1__.exceptionDefs) {
...
const getEndSubPhaseIndex = (inPhaseId, phaseNames) => {
  ...
  let index = phaseNames.lastIndexOf(subPhaseName); //console.log(subPhaseName,index)
...
const setupProblems = (defs, sols, actions) => {
      ...
      for (let entry of actEntries) {
        ...
        switch (act.protocolRelationship) {
          ...
          case "unnecessary":
            ...
            (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.pushNew)(act, problem.allContras); //need to be able to annotate an action without deciding yet on which solution under
          ...
          case "optional":
            ...
            (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.pushNew)(act, problem.allActions); //need to be able to annotate an action without deciding yet on which solution under
  ...
  return problems; //console.log(problems)
...
const insertInPhaseRelativeToSuggestedOrder = (phaseNames, phases, object, orderedArrayObjects, objIndex) => {
  ...
  let phaseIndex = -1; //console.log(object);
  ...
  let objectBefore = orderedArrayObjects[objIndex - 1]; // console.log("Objects before in def", {...objectsBefore})
...
const organizeLogDisplay = (phaseNames, phases) => {
  ...
  for (let phaseIndex = 0; phaseIndex < phaseNames.length; phaseIndex++) {
    ...
    if (iPhaseObjects.length > 0 && process) {
      ...
      subheader.status = (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.getPhaseStatus)(subPhaseStatuses);
      ...
      if (phaseIndex === phaseNames.length - 1) {
        ...
        if (highLevelPhase !== priorHLPhaseItem.label) {
          ...
          header.status = (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.getPhaseStatus)(phaseStatuses);
  ...
  for (const [key, entry] of Object.entries(statusTracking)) {
    if (Array.isArray(entry)) {
      for (let obj of entry) {
        ...
        toUpdate = (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.getEventsByIdTime)(events, obj["intervention"], obj["timestamp"]);
      ...
      toUpdate = (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.getEventsByIdTime)(events, key, entry["timestamp"]);
...
function analyzeEvents(db, scen, log) {
  let events = log.events; //console.log("in analyzeEvents")
  ...
  (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.filterConstraintsBySolutions)(expectedScenInterventions);
  let kbUpdates = checkAgainstKB(phases, phaseNames);
  phases = kbUpdates[0];
  phaseNames = kbUpdates[1];
  console.log("phaseFB = ", phaseFB); //add missing phase names to phaseNames
  ...
  formattedActions = organizeLogDisplay(phaseNames, phases); //console.log("formattedActions after organizeLogDisplay = ", formattedActions)
  ...
  let priorProb = "N/A";
  let finalActions = []; //console.log("formattedActions = ", formattedActions)
  ...
  let pIndex = 0;
  let pActIndex = -1; //console.log("finalActions before minimal check = ", finalActions)
  ...
  /* if (version !== "pre 5/1/22"){
      summary = summarizeAnalysis(finalActions, scenario, constraintsViolated)
      console.log("Condition2 Analysis", summary)} */
  ...
  console.log("Constraint Violation Results", constraintsViolated); //console.log("Final Analysis:", finalActions);
  // save final analysis in a file

  (0,_debriefingUtils__WEBPACK_IMPORTED_MODULE_2__.saveAnalysisLog)(db, log, finalActions, constraintsViolated);
  console.log(finalActions);
  console.log((0,_summarizeAnalysis__WEBPACK_IMPORTED_MODULE_4__.summarizeAnalysis)(finalActions, scen, constraintsViolated)); //else {checkOnOverwriting(log, finalActions)}
  ...
  switch (fbSource) {
    case "json":
      switch (field) {
        ...
        case "why":
          fb = _summarizeAnalysis__WEBPACK_IMPORTED_MODULE_1__.c2FB[currentEntry.id];
        ...
        case "orderingFB":
          fb = _summarizeAnalysis__WEBPACK_IMPORTED_MODULE_1__.c2FB[currentEntry.id]; //if (!fb){fb = c2FB[currentEntry.labelID]}
...
function initializeC2FB(scen) {
  ...
  if (!!phaseIE) {
    ...
    storeLeafActions(top.subActions); //for (let action of top.subActions){
...
const assessmentEntries = {
  ...
  "misOrdered-assessment": ["Problem", "Mis-timed assessment timing issue +bos @orderingFB +eos"],
  ...
  "misOrdered-phase-assessment-option": ["Good", "Section not completed before starting another +bos @orderingFB +eos"],
  ...
  //as long as the intervention was done it is fine to request it
  "patientVitalCheck": ["Good", ""],
  //currently any patient vital check that is done is fine
  "assessment-option-incorrect": ["Problem", "Assessment problem +bos @incorrectAnswerFB +eos "],
  "decision-option-incorrect": ["Problem", "Assessment problem +bos @incorrectAnswerFB +eos "],
  "incorrect-answers": ["Problem", "Intervention problem +bos @incorrectAnswersFB +bos ?intvStatusFB +eos"],
  "minimal-incorrect-answers": ["Problem", "Problems with intervention and violation of protocol +bos ?minimalWhy +bos @incorrectAnswersFB +bos ?intvStatusFB +eos"],
  "minimal": ["Caution", "Intervention violates protocol +bos @minimalWhy +bos ?intvStatusFB +eos "],
  "misOrdered-assessment-option-incorrect": ["Problem", "Problems with assessment and its timing +bos @orderingFB +bos @incorrectAnswerFB +eos "],
  "misOrdered-decision-option-incorrect": ["Problem", "Problems with assessment and its timing +bos @orderingFB +bos @incorrectAnswerFB +eos "],
  "misOrdered-incorrect-answers": ["Problem", "Problems with assessment and its timing +bos @orderingFB +bos @incorrectAnswersFB +bos ?intvStatusFB +eos"],
  "misOrdered-minimal-incorrect-answers": ["Problem", "Problems with intervention and its timing +bos @orderingFB +bos @minimalWhy +bos @incorrectAnswersFB +bos ?intvStatusFB +eos"],
  "misOrdered-minimal": ["Problem", "Problems with intervention and its timing +bos @orderingFB +bos @minimalWhy +bos ?intvStatusFB +eos"],
  "misOrdered-phase-assessment-option-incorrect": ["Problem", "Section was not completed before starting another +bos @orderingFB +bos @incorrectAnswerFB +eos "],
  "misOrdered-phase-decision-option-incorrect": ["Problem", "Section was not completed before starting another +bos @orderingFB +bos @incorrectAnswerFB +eos "],
...
const phaseStatusList = {
  ...
  errors: ["misOrdered-assessment", "misOrdered-assessment-option", "misOrdered-decision-option", "misOrdered-required-action", "misOrdered-goodIntv", "assessment-option-incorrect", "decision-option-incorrect", "incorrect-answers", "minimal-incorrect-answers", //"minimal", 
  ...
  good: ["good", "assessment", "assessment-option", "decision-option", "required-action", "goodIntv", //condition 2 does not address these so put them in the good category
...
const leafStatusList = {
  ...
  error: ["assessment-option-incorrect", "decision-option-incorrect", "incorrect-answers", "minimal-incorrect-answers", "contraindicated", "irrelevant", "unnecessary"],
  good: ["assessment", "assessment-option", "decision-option", "required-action", "goodIntv", //condition 2 does not address these so put them in the good category
